...
function CreateHourLines(data) {
  ...
  for (var i = 0; i < 12; i++) {
    ...
    transform: rotate(-${val}deg) translate(0px,${key2}px)">${val}</span>
    </li>`;
    html +=
      "<li  style='background:#fff; position: absolute;list-style:none; width: 20px;height: 10px; left: 50%;top: 50%;transform-origin: left center;transform: rotate(" +
      val +
      "deg) translate(" +
      key1 +
      "px, " +
