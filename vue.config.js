...
module.exports = {
    ...
    pluginOptions: {
        ...
        electronBuilder: {
            ...
            // electron 构建配置
            builderOptions: {
                productName: 'gcc', // 项目名，也是生成的安装文件名，即electron-admin-antd-vue.exe
                appId: 'gcc.electron-admin-antd-vue', // 包名
                copyright: 'Copyright © 2022-present sunwin', // 版权
                nsis: {
